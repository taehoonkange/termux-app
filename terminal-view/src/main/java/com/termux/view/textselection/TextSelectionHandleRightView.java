...
public class TextSelectionHandleRightView extends TextSelectionHandleView {
    private boolean isInverse;

    public TextSelectionHandleRightView(TerminalView terminalView, CursorController cursorController) {
        super(terminalView, cursorController);

        mHandleDrawable = getContext().getDrawable(R.drawable.text_select_handle_right_material);
    ...
    public void changeOrientation(int posX, final Rect clip) {
        if (posX + mHandleWidth > clip.right) {
